...
Support all major languages: Python, JavaScript, Java, C++, etc.`,
      examplePrompts: [
        'Review this Python function: [paste code]',
        'Find bugs in my JavaScript: [paste code]',
...
- Simulate pressure with follow-up questions
Start by asking what role and company the user is preparing for.`,
      examplePrompts: [
        'Prepare me for a Google SWE interview',
        'Ask me behavioral questions for a PM role',
        'Give feedback on this answer: [paste answer]',
      ],
      price: 99,
            ...
            <button
              ...
              onClick={() => {
                const templateForm = {
                  ...
                  examplePrompts: t.form.examplePrompts,
                };
